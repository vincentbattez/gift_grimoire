...
export const ENIGMAS: Enigma[] = z.array(enigmaSchema).parse([
  {
    ...
    question:
      `Tout le monde ici voit l'extraordinaire sans effort. Moi, j'ai besoin d'aide pour voir l'ordinaire. Et pourtant, je suis la seule à avoir vu ce qui allait nous détruire`,
    answer: "mirabel",
    rune: "ᚠ",
    boxNumber: 5,
    ...
    loveLetter: {
      ...
      message:
      `Comme Mirabel, tu n'as besoin d'aucun pouvoir magique pour être extraordinaire.
  ...
  },
  {
    ...
    question:
      `Chaque année, le ciel me parle. Des centaines de voix silencieuses flottent vers moi, et je suis la seule à croire qu'elles me cherchent. Tout le monde y voit une fête. Moi, j'y vois une question`,
    answer: "raiponce",
    rune: "ᚲ",
    boxNumber: 2,
    ...
    loveLetter: {
      ...
      message:
        `Tu es ma Raiponce. Il y a en toi cette lumière que rien ne peut éteindre.
  ...
  },
  {
    ...
    question:
      `Il m'a invitée à danser sans un mot et sans musique. Sa main ne trouvait pas la mienne. Son corps partait dans le mauvais sens. Il ressemblait à tout sauf à un danseur.
    ...
    loveLetter: {
      ...
      message:
        `Comme Wall-E, tu avances. Doucement, obstinément, même quand tout s'accumule, même quand ça pèse. Tu ne fais pas de bruit avec ta force, tu la portes, et ça se voit dans chaque chose que tu traverses sans jamais perdre ce qui te rend toi
  ...
  },
  {
    ...
    loveLetter: {
      ...
      message:
        `Comme Bruno, tu vois ce que les autres ne voient pas. Par cette sensibilité profonde qui t'habite et que peu de gens savent vraiment reconnaître, tu perçois les émotions, les non-dits, les détails que personne d'autre ne remarque. Tu as ce don de voir l'invisible, de ressentir ce qui est caché.
  ...
  },
  {
    ...
    question:
      `Le jour où ma force a vacillé, je n'ai pas eu peur de souffrir. J'ai eu peur qu'on ne me regarde plus. Car ici, on ne m'aime pas pour ce que je suis, on m'aime pour ce que je soulève.`,
    answer: "luisa",
    rune: "ᚢ",
    boxNumber: 3,
    ...
    loveLetter: {
      ...
      message:
        `Comme Luisa, Tu portes les autres, leurs peines, leurs besoins, leurs urgences, avec une fiabilité que tout le monde remarque sans jamais vraiment mesurer ce que ça te coûte.
  ...
  },
  {
    ...
    loveLetter: {
      ...
      message:
        `Comme EVE, tu as cette grâce qui me désarme à chaque fois. Tu es brillante, déterminée, capable de tout, et c'est quand tu n'as pas conscience de ta beauté qu'elle me frappe le plus
