...
export const ENIGMAS_DATA: EnigmaData[] = [
  {
    ...
    transition: "De l'Ombre vers le Royaume",
    ...
    hint: "En contrebas, près du reflet de vérité…",
    stains: [1, 2],
  },
  {
    number: "II",
    subtitle: "Deuxième Énigme",
    transition: "Du Royaume vers l'Orient",
    title: "« Du Royaume Enchanté\naux Lames d'Orient »",
    riddle:
    ...
    hint: "Le plus petit cadre sombre, en contrebas à gauche…",
    stains: [1],
  },
  {
    number: "III",
    subtitle: "Troisième Énigme",
    transition: "Des Démons vers les Géants",
    ...
    hint: "Tout en haut, à gauche, sous le soleil couchant…",
    stains: [2],
  },
  {
    number: "IV",
    subtitle: "Quatrième Énigme",
    transition: "Des Murs vers la Mer",
    ...
    hint: "Juste à droite, là où l'eau turquoise t'appelle…",
    stains: [1, 2],
  },
  {
    number: "V",
    subtitle: "Cinquième Énigme",
    transition: "De l'Île au Miracle",
    ...
    hint: "Le plus petit cadre doré, à droite du miroir…",
    stains: [1],
  },
  {
    number: "VI",
    subtitle: "Sixième Énigme",
    transition: "Du Miracle à la Cuisine",
    ...
    hint: "En bas, près de l'étagère, cadre sombre…",
    stains: [2],
  },
  {
    number: "VII",
    subtitle: "Septième Énigme",
    transition: "De la Cuisine à la Sorcellerie",
    title: "« Du Rat sous la Toque\nau Rat sous la Cape »",
    riddle:
    ...
    hint: "Juste à côté, dans un cadre sombre…",
    stains: [1, 2],
  },
  {
    number: "VIII",
    subtitle: "Huitième Énigme",
    transition: "De la Magie vers les Étoiles",
    title: "« Quand les Sorciers\nont quitté la Terre »",
    riddle:
    ...
    hint: "Cadre doré, en bas à gauche…",
    stains: [1],
  },
  {
    number: "IX",
    subtitle: "Neuvième Énigme",
    transition: "Des Étoiles aux Cerisiers",
    title: "« De l'Amour des Étoiles\nà celui des Cerisiers »",
    riddle:
    ...
    hint: "Tout en haut, à droite, cadre doré fleuri…",
    stains: [2],
  },
  {
    number: "X",
    subtitle: "Énigme Finale",
    transition: "Le Dénouement",
    ...
    hint: "Trois coups suffisent pour ouvrir un monde…",
    stains: [1, 2],
  },
];
